...
class_names = ['', '', '', 'summoner-wrapper', '', 'skill-order clearfix', 'o-wrap', '', 'build-wrapper', '',
               'build-wrapper', '']  # Array to hold the class names we care about


# Loop cycles through the 6 important parts of the page and makes pictures of them
for i in range(3, 11, 2):  # Weird class_names array spacing lines it up to make an easy loop with the text array
